...
const ViewTable = () => {
  const { viewDataList } = useContext(DataApiData)
        ...
        >
          {viewDataList.map((item) => (
            <tr key={item.id} className="border-t border-gray-200">
              ...
              <td className="border border-gray-200 py-4 px-2">{item.sex}</td>
              <td className="border border-gray-200 py-4 px-2">{item.race}</td>
              <td className="border border-gray-200 py-4 px-2">
                {item.ethnicity}
              </td>
              <td className="border border-gray-200 py-4 px-2">{item.age}</td>
              <td className="border border-gray-200 py-4 px-2">
                {item.geography}
              </td>
              <td className="border border-gray-200 py-4 px-2">
              ...
              <td className="border border-gray-200 py-4 px-2">{item.note}</td>
            </tr>
          ))}
        </tbody>
      </table>
